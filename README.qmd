---
title: "Reading & Writing Spatial Files in R with sf package"
author: "Mike Proctor"
format: gfm
editor: visual
eval: true
...
### Write a file with a timestamp in filename - This works with any filename - csv, xlsx etc
...
fred <- CountyCentroids |> 
  sf::st_as_sf(coords=c("easting","northing"), crs=32614) # make sure you get x and y coords in right order
